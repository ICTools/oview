...
**Status:** ✅ Embeddings tests done (17 test functions, 116 subtests)
         ✅ Indexer tests done (20 test functions covering chunker + indexer)
         Total: 37 test functions created
         🔄 Next: MCP + treesitter tests...
